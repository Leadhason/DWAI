...
import { PhoneIncoming, DatabaseZap, CalendarCheck, Clock, ServerCog, LucideIcon } from 'lucide-react';
...
export const SolutionsPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Automation Solutions | Driftwood AI</title>
        <meta name="description" content="Explore our suite of Voice AI agents including Inbound Support, Lead Qualification, and Internal Operations automation." />
      </Helmet>
