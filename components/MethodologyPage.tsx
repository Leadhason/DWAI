...
export const MethodologyPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Methodology | Driftwood AI</title>
        <meta name="description" content="Our 7-step Service Delivery Lifecycle ensures reliable, scalable, and effective Voice AI implementation." />
      </Helmet>
